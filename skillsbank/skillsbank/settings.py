"""
Django settings for skillsbank project.
...
WSGI_APPLICATION = 'skillsbank.wsgi.application'
...
if not EMAIL_DEFAULT_SENDER:
    raise ValueError("EMAIL_DEFAULT_SENDER is not set in the .env file 1!")
